      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-violet-600 via-indigo-600 to-blue-500 items-center justify-center p-12">
        <div className="text-white text-center">
          ...
          <div className="mt-12 space-y-4">
            {[
              { icon: <Star size={16} />, text: 'Free to use' },
              { icon: <ShieldCheck size={16} />, text: 'Secure & Private' },
              { icon: <User size={16} />, text: 'Easy to manage' },
            ].map((item) => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-gray-500 mt-2">Sign up and start managing users</p>
          </div>
